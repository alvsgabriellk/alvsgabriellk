...
<!-- Typing SVG animado -->
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=28&pause=1000&color=00FF94&center=true&vCenter=true&width=600&lines=Ol%C3%A1%2C+eu+sou+Cau%C3%A3+Gabriell;Dev+Back-end+%7C+Automação+%7C+APIs;)](https://git.io/typing-svg)
...
class CauaGabriell:
    def __init__(self):
        self.role        = "Dev Back-end"
        self.education   = "Análise e Desenvolvimento de Sistemas"
        self.interests   = ["Engenharia de Software", "Automação", "APIs REST", "Web"]
        self.currently   = "Construindo sistemas que escalam"
        self.goal        = "Transformar lógica em soluções reais"

    def __str__(self):
        return "Apaixonado por código limpo e sistemas bem arquitetados."
```
...
### 🌐 APIs & Protocolos
<div style="display: flex; flex-wrap: wrap; gap: 8px;"><br/>
  <img align="center" alt="REST API" src="https://img.shields.io/badge/REST%20API-%23000000.svg?style=for-the-badge&logo=fastapi&logoColor=white" />
</div><br/>
